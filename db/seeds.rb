...
buchers_daughter = Restaurant.create(name: "The Bucher's Daughter", address: "19 Kenemare St, New York, NY 10012", price: "2", img_url: 'https://images.getbento.com/accounts/2f9a5949ac10f668443d4e18b37daba2/media/images/19198Untitled-4.jpg?w=1200&fit=max&auto=compress,format')
peasant = Restaurant.create(name: "Peasant", address: "194 Elizabeth St, New York, NY 10012", price: "3",  img_url: 'https://images.getbento.com/accounts/f138bbdef6acf27b7aeb26b268d20984/media/images/42129DSC_1032.jpg?w=1800&fit=max&auto=compress,format')
jacks_wife_freda = Restaurant.create(name: "Jack's Wife Freda", address: "266 Lafyette St, New York, NY 10012", price: "2", img_url: 'https://vanessas.com/wp-content/uploads/2018/06/6-e1531411042556-923x1230.jpg')
vanessas_dumpling_house = Restaurant.create(name: "Vanessa's Dumpling House", address: "118A Eldridge St, New York, NY 10002", price: "1", img_url: 'https://scontent-lax3-2.cdninstagram.com/v/t51.29350-15/272084019_133977372431797_5559187624305038071_n.jpg?_nc_cat=108&ccb=1-7&_nc_sid=8ae9d6&_nc_ohc=ybJw3C2xI08AX8Bd2QA&_nc_ht=scontent-lax3-2.cdninstagram.com&edm=ANo9K5cEAAAA&oh=00_AfDySVbDhno3eAhSRt8AGNjhFIWNv1YJNTiPWtTlTC6DMQ&oe=63D7F478')
sunday_to_sunday = Restaurant.create(name: "Sunday to Sunday", address: "88 Orchard Street, New York, NY 10002", price: "2", img_url: 'https://images.squarespace-cdn.com/content/v1/63597d7201bf0339110b052a/6d1b5764-84fc-4914-8ca5-0a2e6b5dccf5/10.13.22+Emporio-62586-HDR-Edit.jpg?format=2500w')
emporio = Restaurant.create(name: "Emporio", address: "231 Mott St, New York, NY 10012", price: "2", img_url: 'https://lh5.googleusercontent.com/p/AF1QipPyOS1lPc_8zofSKSAoK-sdZ615qKHSCOJz9-fB=w408-h272-k-no')
lure_fishbar = Restaurant.create(name: "Lure Fishbar", address: "142 Mercer St, New York, NY 10012", price: "3", img_url: '')
little_prince = Restaurant.create(name: "Little Prince", address: "199 Prince St, New York, NY 10012", price: "2", img_url:'https://static.urbandaddy.com/uploads/assets/image/articles/standard/a36c43dd026a9f97a083ac1ac498c18c.jpg')
lola_taverna = Restaurant.create(name: "Lola Taverna", address: "210 6th Ave, New York, NY 10014", price: "3", img_url: 'https://images.squarespace-cdn.com/content/v1/55c8d2a4e4b0168e0edc0b4b/1439247238380-PRL9X5B0SJO9R8LLD45J/front-room.jpg?format=2500w')
gelso_grand = Restaurant.create(name: "Gelso & Grand", address: "186 Grand St, New York, NY 10013", price: "2", img_url: 'https://mediaprocessor.websimages.com/width/481/crop/17,0,324x217/mrtakaramen.webs.com/Mr.Taka.jpg')
wayan = Restaurant.create(name: "Wayan", address: "20 Spring St, New York, NY 10012", price: "3", img_url: '')
freemans = Restaurant.create(name: "Freemans", address: "Freeman Alley, New York, NY 10002", price: "2", img_url: 'https://images.squarespace-cdn.com/content/v1/55c8d2a4e4b0168e0edc0b4b/1439247238380-PRL9X5B0SJO9R8LLD45J/front-room.jpg?format=2500w')
mr_taka = Restaurant.create(name: "Mr Taka Ramen", address: "170 Allen St, New York, NY 10002", price: "2", img_url: 'https://mediaprocessor.websimages.com/width/481/crop/17,0,324x217/mrtakaramen.webs.com/Mr.Taka.jpg')
tao_downtown = Restaurant.create(name: "Tao Downtown", address: "92 9th Ave, New York, NY 10011", price: "3", img_url: 'https://taogroup.com/wp-content/uploads/2022/04/taodowntown_275543789_104655248803342_8474946259242303409_n.jpg')
jungle_bird = Restaurant.create(name: "Jungle Bird", address: "178 8th Ave< New York, NY 10011", price: "2", img_url: 'https://images.squarespace-cdn.com/content/v1/5ba301a9f93fd49b0be12377/1557777895163-JEH4FVJXZW2ALBEB85X3/unnamed.jpg?format=750w')
coopers_craft = Restaurant.create(name: "Cooper's Craft & Cocktails", address: "169 8th Ave, New York, NY 10011", price: "1", img_url: 'https://images.squarespace-cdn.com/content/v1/60ddc2f15341fc7bddf51715/b00c656e-65dc-4796-8dec-1c6a5a488314/DSC07863+%281%29.jpg?format=2500w')
disco_taco = Restaurant.create(name: "Disco Tacos", address: "80 N 6th St, Brooklyn, NY 11249", price: "1")
freehold = Restaurant.create(name: "Freehold", address: "45 S 3rd St, Brooklyn, NY 11249 ", price: "1" img_url: 'https://images.squarespace-cdn.com/content/v1/604838332b7160066b7ee1db/7c60c0fe-2a38-4862-bb81-f2035674b0bf/DSCF5671-HDR.jpg?format=2500w')
